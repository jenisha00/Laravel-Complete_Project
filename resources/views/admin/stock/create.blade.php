...
@section('content')
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h2 class="m-1 mb-3 text-dark"><i class="fas fa-plus-circle ml-2 mr-2"></i>Add Stock</h2>
          @if(session('message'))
           ...
           <div class="form-group">                
            ...
            <!-- <div class="form-group">                
                ...
                <div class="col-md-6 input-group">
                  <input type="number" name="unit_price" step="0.01" placeholder="Unit Price" class="form-control">
            ...
            <div class="form-group">
                <input type="submit" class="btn btn-primary ml-3" value="Add Stock">
            </div>
        </form>
      </div>
  </section>
